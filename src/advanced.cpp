...
void advanced(string selectedCase)
{
    ...
    cout << "start my advanced version of data structure final from here!" << endl;
    ...
    user_request_advanced(dist_matrix, user_list, user_num,
                          station_bike_list, count_limit, decedant_rate, Map.station_num);
